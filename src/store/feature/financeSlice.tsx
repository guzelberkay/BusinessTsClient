...
//#region Declaration
interface IFetchCreateDeclaration {
    startDate: Date;
    endDate: Date;
}
...
export const fetchCreateDeclarationForIncomeTax = createAsyncThunk(
    ...
    async (payload: IFetchCreateDeclaration) => {
        ...
        const result = await axios.post(
            RestApis.finance_service_declaration + "/create-for-income-tax",
            declaration,
            {
                headers: {
                    'Content-Type': 'application/json'
...
export const fetchCreateDeclarationForVat = createAsyncThunk(
    'finance/fetchCreateDeclarationForVat',
    async (payload: IFetchCreateDeclaration) => {
        const declaration = {
            startDate: payload.startDate,
            endDate: payload.endDate
        ...
        const result = await axios.post(
            RestApis.finance_service_declaration + "/create-for-vat",
            declaration,
            {
                headers: {
                    'Content-Type': 'application/json'
...
export const fetchCreateDeclarationForCorporateTax = createAsyncThunk(
    'finance/fetchCreateDeclarationForCorporateTax',
    async (payload: IFetchCreateDeclaration) => {
        const declaration = {
            startDate: payload.startDate,
            endDate: payload.endDate
        ...
        const result = await axios.post(
            RestApis.finance_service_declaration + "/create-for-corporate-tax",
            declaration,
            {
                headers: {
                    'Content-Type': 'application/json'
...
export const fetchApproveExpense = createAsyncThunk(
    'finance/fetchApproveExpense',
    async (id: number) => {
        const result = await axios.post(
            RestApis.finance_service_expense + "/approve?id=" + id,
            {
                headers: {
                    'Content-Type': 'application/json'
                }
