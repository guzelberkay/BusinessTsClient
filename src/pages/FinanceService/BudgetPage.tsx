    ...
    return (
        <div style={{height: "auto"}}>
            ...
            <Grid container spacing={2} sx={{ flexGrow: 1, justifyContent: 'flex-start', alignItems: 'stretch', marginTop: '2%', marginBottom: '2%' }}>
                ...
                <Dialog open={openSaveBudgetModal} onClose={() => setOpenSaveBudgetModal(false)} fullWidth maxWidth='sm'>
                    <DialogContent>
                        <TextField
                            sx={{marginTop:'15px'}}
                    ...
                    <DialogActions>
                        ...
                        {
                           isUpdating ?
                               <Button onClick = {() => handleUpdateBudget()} color = "success" variant = "contained" disabled = {department === '' || year === 0 || amount === 0 || description === ''}>{t('financeService.update')}</Button>
                            :
                                <Button onClick = {() => handleSaveBudget()} color = "success" variant = "contained" disabled = {department === '' || year === 0 || amount === 0 || description === ''}>{t('financeService.save')}</Button>
                            }
                    </DialogActions>
                </Dialog>
            </Grid>
